...
class DriverController extends Controller
{
    ...
    public function simpan(Request $request)
    {
        $pesanKustom = [
            ...
            'no_ktp.required' => 'NIK (Nomor Induk Kependudukan) wajib diisi.',
            'no_ktp.digits' => 'NIK wajib terdiri dari tepat 16 digit angka numerik resmi.',
            'no_ktp.numeric' => 'NIK hanya boleh berisi karakter angka (0-9).',
