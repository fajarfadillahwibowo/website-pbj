                        ...
                        <tr x-show="apakahBarisTampil({{ $loop->index }})" 
                            ...
                            <td class="px-4 py-3.5 text-center whitespace-nowrap">
                                <x-menu-aksi-tabel 
                                    ...
                                    labelDetail="Detail Tarif OA"
                                    :aksiCetak="'cetakKetetapanOA(\'' . $oa->kode_oa . '\')'"
                                    labelCetak="Cetak Ketetapan OA"
                                    aksiEdit="bukaModalEdit('{{ $oa->kode_oa }}')"
                                    labelEdit="Ubah Data Tarif"
                                    modulIzin="kirim_ongkos"
                                >
                                    <div x-show="!apakahReadOnly('kirim_ongkos')" class="border-t border-slate-100 dark:border-[#252837] pt-1 mt-1">
                                        <button @click.stop="menuTerbuka = false; bukaModalHapus('{{ $oa->kode_oa }}', '{{ addslashes($oa->nama_oa) }}')"
                                                type="button"
        ...
        <div @click.away="modalDetailTerbuka = false"
            ...
            <div class="flex items-center justify-between px-6 py-4 border-b border-[#E2E8F0] dark:border-[#252837] bg-slate-50 dark:bg-[#1C1E2A]">
                ...
                <div class="flex items-center gap-2">
                    <button @click="cetakDokumenOA()" type="button" class="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold text-slate-700 dark:text-slate-300 bg-white hover:bg-slate-100 dark:bg-[#14161F] dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg transition-colors">
                        <svg class="w-3.5 h-3.5 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M17 17h2a2 2 0 002-2v-4a2 2 0 00-2-2H5a2 2 0 00-2 2v4a2 2 0 002 2h2m2 4h6a2 2 0 002-2v-4a2 2 0 00-2-2H9a2 2 0 00-2 2v4a2 2 0 002 2zm8-12V5a2 2 0 00-2-2H9a2 2 0 00-2 2v4h10z"/></svg>
                        <span>Cetak Ketetapan</span>
                    </button>
            ...
            <!-- Konten Detail & Lembar Cetak Ketetapan Tarif OA -->
            <div id="areaCetakOA" class="p-6 space-y-4 text-xs">
                ...
                <div class="border-b-2 border-slate-900 pb-3 mb-4 flex items-center justify-between">
                    <div>
                        ...
                        <div class="text-[10px] text-slate-600">Divisi Operasional Logistik, Distribusi & Transportasi Semen</div>
                        <div class="text-[9px] text-slate-500">Surat Ketetapan Tarif Resmi Ongkos Angkut (OA) & Alokasi Muatan KSO</div>
                    </div>
                ...
                <!-- Tanda Tangan Resmi Cetak Ketetapan OA -->
                <div class="pt-6 grid grid-cols-2 gap-8 text-center text-[10px]">
                    <div>
                        <div class="text-slate-500 mb-12">Disiapkan & Ditetapkan Oleh:</div>
                        <div class="font-bold underline text-slate-900">( ........................................ )</div>
                        <div class="text-slate-400">SPV Operasional & Logistik</div>
                    </div>
                    <div>
                        <div class="text-slate-500 mb-12">Disetujui & Disahkan Oleh:</div>
                        <div class="font-bold underline text-slate-900">( ........................................ )</div>
                        <div class="text-slate-400">Direktur / General Manager</div>
                    </div>
                </div>
...
<script>
    function kelolaOngkosAngkut() {
        return {
            ...
            cetakDokumenOA() {
                const isiCetak = document.getElementById('areaCetakOA').innerHTML;
                const jendelaCetak = window.open('', '_blank', 'height=700,width=900');
                jendelaCetak.document.write('<html><head><title>Ketetapan Tarif OA - ' + (this.detailOa.kode_oa || '') + '</title>');
