                        ...
                        <tr x-show="apakahBarisTampil({{ $loop->index }})" 
                            ...
                            <td class="px-4 py-3.5 text-center whitespace-nowrap">
                                <x-menu-aksi-tabel 
                                    ...
                                    labelSalin="Salin Kode Part"
                                    aksiEdit="bukaModalEdit('{{ $part->kode_sparepart }}')"
                                    labelEdit="Ubah Sparepart"
                                    modulIzin="bengkel_sparepart"
                                >
                                    <!-- Aksi Mutasi Stok Cepat -->
                                    <template x-if="!apakahReadOnly('bengkel_sparepart') && !apakahReadOnly('ops_bengkel')">
                                        <button @click.stop="menuTerbuka = false; bukaModalMutasi('{{ $part->kode_sparepart }}', '{{ addslashes($part->nama_sparepart) }}', {{ $part->stok_part }}, '{{ $part->satuan }}')"
                                                type="button"
                                            ...
                                            <svg class="w-3.5 h-3.5 text-slate-400 group-hover:text-sky-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    ...
                                    <template x-if="!apakahReadOnly('bengkel_sparepart') && !apakahReadOnly('ops_bengkel')">
                                        <div class="border-t border-slate-100 dark:border-[#252837] pt-1 mt-1">
                                            <button @click.stop="menuTerbuka = false; bukaModalHapus('{{ $part->kode_sparepart }}', '{{ addslashes($part->nama_sparepart) }}')"
                                                    type="button"
