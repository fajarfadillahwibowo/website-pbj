...
@section('judul', 'Master Data Barang & Semen')
...
<div class="space-y-5">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white dark:bg-[#14161F] p-4 sm:p-5 rounded-2xl border border-[#E2E8F0] dark:border-[#252837] shadow-sm">
        <div>
            ...
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Master produk semen zak (PCC/OPC), semen curah, harga pokok beli, dan default jual.</p>
        </div>
    ...
    <div class="bg-white dark:bg-[#14161F] border border-[#E2E8F0] dark:border-[#252837] rounded-2xl overflow-hidden shadow-sm">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 px-5 py-3.5 border-b border-[#E2E8F0] dark:border-[#252837]">
            <div class="relative w-full sm:w-64">
                <input type="text" placeholder="Cari kode / nama produk..."
            ...
            <table class="w-full text-xs">
                <thead class="bg-[#F8FAFC] dark:bg-[#1C1E2A] border-b border-[#E2E8F0] dark:border-[#252837] text-slate-500">
                    <tr>
                        ...
                        <th class="px-4 py-2.5 text-left font-semibold uppercase tracking-wider">Nama Produk</th>
                        <th class="px-4 py-2.5 text-left font-semibold uppercase tracking-wider">Kemasan / Berat</th>
                        <th class="px-4 py-2.5 text-right font-semibold uppercase tracking-wider">Harga Beli Pabrik</th>
                        <th class="px-4 py-2.5 text-right font-semibold uppercase tracking-wider">Harga Jual Default</th>
                        <th class="px-4 py-2.5 text-right font-semibold uppercase tracking-wider">Total Stok</th>
                        <th class="px-4 py-2.5 text-center font-semibold uppercase tracking-wider">Aksi</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-[#EEF0F4] dark:divide-[#252837] text-slate-700 dark:text-slate-300">
                    <tr class="hover:bg-[#F8FAFC] dark:hover:bg-[#252837]/50 transition-colors">
                        <td class="px-4 py-3 font-mono font-medium text-amber-600 dark:text-amber-400">SMN-PCC-50</td>
                        <td class="px-4 py-3 font-bold text-slate-900 dark:text-slate-100">Semen Gresik PCC 50 Kg</td>
                        <td class="px-4 py-3">Zak · 50 Kg</td>
                        <td class="px-4 py-3 text-right font-mono tabular-nums text-slate-500">Rp 58.000</td>
                        <td class="px-4 py-3 text-right font-mono tabular-nums font-semibold text-emerald-600 dark:text-emerald-400">Rp 64.500</td>
                        <td class="px-4 py-3 text-right font-mono tabular-nums font-bold text-slate-900 dark:text-slate-100">8.500 Zak</td>
                    ...
                    <tr class="hover:bg-[#F8FAFC] dark:hover:bg-[#252837]/50 transition-colors">
                        <td class="px-4 py-3 font-mono font-medium text-amber-600 dark:text-amber-400">SMN-PCC-40</td>
                        <td class="px-4 py-3 font-bold text-slate-900 dark:text-slate-100">Semen Gresik PCC 40 Kg</td>
                        <td class="px-4 py-3">Zak · 40 Kg</td>
                        <td class="px-4 py-3 text-right font-mono tabular-nums text-slate-500">Rp 47.000</td>
                        <td class="px-4 py-3 text-right font-mono tabular-nums font-semibold text-emerald-600 dark:text-emerald-400">Rp 52.000</td>
                        <td class="px-4 py-3 text-right font-mono tabular-nums font-bold text-slate-900 dark:text-slate-100">5.750 Zak</td>
                        <td class="px-4 py-3 text-center space-x-2">
                            <button class="text-blue-600 dark:text-blue-400 hover:underline font-medium">Edit</button>
                            <span class="text-slate-300 dark:text-slate-700">|</span>
                            <button class="text-red-600 dark:text-red-400 hover:underline font-medium">Hapus</button>
