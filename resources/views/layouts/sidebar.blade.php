        ...
        <div x-show="bisaAkses('kirim_sj') || bisaAkses('kirim_ongkos') || bisaAkses('gudang_stok') || bisaAkses('gudang_opname') || bisaAkses('armada_truk') || bisaAkses('armada_driver') || bisaAkses('ops_kso') || bisaAkses('bengkel_perbaikan') || bisaAkses('bengkel_pembelian_sparepart') || bisaAkses('bengkel_sparepart')">
            ...
            <div class="space-y-1">
                <a x-show="bisaAkses('kirim_ongkos')" href="{{ route('operasional.pengiriman.ongkos_angkut') }}"
                   :class="sidebarTerlipat ? 'justify-center px-0' : 'px-2.5'"
                   class="flex items-center gap-2.5 py-1.5 rounded-xl transition-all duration-150 group {{ request()->routeIs('operasional.pengiriman.ongkos_angkut') ? 'font-bold text-slate-900 dark:text-white bg-slate-100 dark:bg-[#1E212E] border-l-[3.5px] border-slate-700 shadow-xs' : 'text-slate-600 dark:text-slate-400 hover:bg-slate-100/80 dark:hover:bg-[#1E212E] hover:text-slate-900 dark:hover:text-white font-medium border-l-[3.5px] border-transparent' }}"
                   :title="sidebarTerlipat ? 'Data Ongkos Angkut' : ''">
                    <div class="w-7 h-7 rounded-lg flex items-center justify-center shrink-0 transition-all {{ request()->routeIs('operasional.pengiriman.ongkos_angkut') ? 'bg-slate-700 text-white shadow-xs' : 'bg-slate-100 dark:bg-[#1E212E] text-slate-500 dark:text-slate-400 group-hover:bg-slate-200 dark:group-hover:bg-slate-700 group-hover:text-slate-900 dark:group-hover:text-white' }}">
