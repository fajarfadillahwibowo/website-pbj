...
<aside :class="sidebarTerlipat ? 'w-16' : 'w-64'"
    ...
    <!-- Header Sidebar: Logo Perusahaan & Toggle Ciutkan -->
    <div class="h-14 flex items-center border-b border-[#E2E8F0] dark:border-[#252837] shrink-0 transition-all duration-200"
        ...
        <template x-if="!sidebarTerlipat">
            <div class="flex items-center justify-between w-full min-w-0">
                <div class="flex items-center gap-2.5 min-w-0 overflow-hidden">
                    <div class="w-8 h-8 rounded-xl bg-blue-600 flex items-center justify-center shadow-sm shadow-blue-600/30 shrink-0">
        ...
        <template x-if="sidebarTerlipat">
            <button @click="sidebarTerlipat = false"
                    class="w-9 h-9 rounded-xl bg-blue-600 hover:bg-blue-700 flex items-center justify-center shadow-sm shadow-blue-600/30 transition-transform active:scale-95 group relative"
                    title="Buka Sidebar (PT Pura Balkom Jaya)">
    ...
    <nav class="flex-1 overflow-y-auto py-3 px-2 space-y-3.5 text-xs">

        <!-- 1. Menu Utama -->
        <div>
            <div x-show="!sidebarTerlipat" class="px-2.5 mb-1.5 text-[10px] font-semibold text-slate-400 uppercase tracking-widest">Utama</div>
            <a href="{{ route('dashboard') }}"
               :class="sidebarTerlipat ? 'justify-center px-0' : 'px-2.5'"
               class="flex items-center gap-2.5 py-2 rounded-xl font-semibold text-blue-700 dark:text-blue-400 bg-blue-50 dark:bg-blue-500/10 transition-colors"
        ...
        <div x-show="bisaAkses('admin_akun')">
            ...
            <div class="space-y-0.5">
                <a href="{{ route('superadmin.kelola_akun') }}"
                   :class="sidebarTerlipat ? 'justify-center px-0' : 'px-2.5'"
                   class="flex items-center gap-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors"
        ...
        <div x-show="bisaAkses('ar_faktur') || bisaAkses('ar_piutang') || bisaAkses('ar_deposit') || bisaAkses('ap_pembelian') || bisaAkses('list_so') || bisaAkses('ap_pengeluaran') || bisaAkses('akun_coa') || bisaAkses('akun_jurnal') || bisaAkses('akun_aset') || bisaAkses('jenis_aset')">
            ...
            <div class="space-y-0.5">
                ...
                <a x-show="bisaAkses('jenis_aset') || bisaAkses('akun_aset')" href="{{ route('keuangan.akuntansi.aset') }}"
                   :class="sidebarTerlipat ? 'justify-center px-0' : 'px-2.5'"
                   class="flex items-center gap-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors"
                   :title="sidebarTerlipat ? 'Data Jenis Aset' : ''">
    ...
    <div class="shrink-0 p-2 border-t border-[#E2E8F0] dark:border-[#252837]">
        <div class="flex items-center rounded-xl bg-slate-50 dark:bg-[#1C1E2A] border border-[#E2E8F0] dark:border-[#252837] transition-all"
             :class="sidebarTerlipat ? 'justify-center p-1.5' : 'gap-2.5 px-2 py-1.5'">
