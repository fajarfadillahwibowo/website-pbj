<!-- ================================================================
     SIDEBAR NAVIGASI MENYELURUH (MODULAR DEVELOPER 1 & DEVELOPER 2)
================================================================ -->
<aside :class="sidebarTerlipat ? 'w-16' : 'w-64'"
    ...
    <nav class="flex-1 overflow-y-auto py-3 px-2.5 space-y-4 text-xs">
        ...
        <!-- 2. Kontrol Sistem (Super Admin - Dev 1) -->
        <div x-show="jabatanAktif === 'SUPER_ADMIN' || !filterRoleAktif">
            <div x-show="!sidebarTerlipat" class="px-2 mb-1.5 flex items-center justify-between">
                <span class="text-[10px] font-semibold text-purple-600 dark:text-purple-400 uppercase tracking-widest">Sistem (Dev 1)</span>
                <span class="text-[9px] px-1.5 py-0.5 rounded bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 font-mono">Admin</span>
            </div>
            <div class="space-y-0.5">
                <a href="{{ route('superadmin.kelola_akun') }}" class="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
                    ...
                    <span x-show="!sidebarTerlipat" class="truncate">Kelola Akun Staf</span>
                </a>
            </div>
        </div>

        <!-- 3. Master Data Sentral (Dev 1) -->
        <div>
            <div x-show="!sidebarTerlipat" class="px-2 mb-1.5 flex items-center justify-between">
                <span class="text-[10px] font-semibold text-slate-400 uppercase tracking-widest">Master Data (Dev 1)</span>
            </div>
            <div class="space-y-0.5">
                <a href="{{ route('master.customer.index') }}" class="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
                ...
                <a href="{{ route('master.barang.index') }}" class="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
                ...
                <a href="{{ route('master.wilayah.index') }}" class="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
                ...
                <a href="{{ route('master.karyawan.index') }}" class="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
        ...
        <!-- 4. Keuangan & Akuntansi (Dev 1) -->
        <div>
            <div x-show="!sidebarTerlipat" class="px-2 mb-1.5 flex items-center justify-between">
                <span class="text-[10px] font-semibold text-emerald-600 dark:text-emerald-400 uppercase tracking-widest">Keuangan & AR/AP (Dev 1)</span>
            </div>
            <div class="space-y-0.5">
                <!-- AR -->
                <a href="{{ route('keuangan.ar.faktur') }}" class="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
                ...
                <a href="{{ route('keuangan.ar.piutang') }}" class="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
                ...
                <a href="{{ route('keuangan.ar.deposit') }}" class="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
                ...
                <!-- AP -->
                <a href="{{ route('keuangan.ap.pembelian_so') }}" class="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
                ...
                <a href="{{ route('keuangan.ap.pengeluaran') }}" class="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
                    ...
                    <span x-show="!sidebarTerlipat" class="truncate">Pengeluaran Kas & Rilisan</span>
                </a>
                <!-- Akuntansi -->
                <a href="{{ route('keuangan.akuntansi.kode_akun') }}" class="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
                ...
                <a href="{{ route('keuangan.akuntansi.jurnal') }}" class="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
        ...
        <!-- 5. Operasional, Logistik & Armada (Dev 2) -->
        <div>
            <div x-show="!sidebarTerlipat" class="px-2 mb-1.5 flex items-center justify-between">
                <span class="text-[10px] font-semibold text-blue-600 dark:text-blue-400 uppercase tracking-widest">Operasional & Logistik (Dev 2)</span>
            </div>
            <div class="space-y-0.5">
                <!-- Pengiriman & Dispatcher -->
                <a href="{{ route('operasional.pengiriman.surat_jalan') }}" class="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
                ...
                <a href="{{ route('operasional.pengiriman.ongkos_angkut') }}" class="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
                ...
                <!-- Gudang -->
                <a href="{{ route('operasional.gudang.stok') }}" class="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
                    <svg class="w-4 h-4 shrink-0 text-amber-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10"/></svg>
                    <span x-show="!sidebarTerlipat" class="truncate">Gudang & Stok Semen</span>
                </a>
                <a href="{{ route('operasional.gudang.opname') }}" class="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
                ...
                <!-- Armada & Driver -->
                <a href="{{ route('operasional.armada.kendaraan') }}" class="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
                ...
                <a href="{{ route('operasional.armada.driver') }}" class="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
                ...
                <!-- Bengkel -->
                <a href="{{ route('operasional.bengkel.perbaikan') }}" class="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
                    ...
                    <span x-show="!sidebarTerlipat" class="truncate">SPK Perbaikan & Sparepart</span>
                </a>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="space-y-0.5">
                <a href="{{ route('laporan.neraca') }}" class="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
                    <svg class="w-4 h-4 shrink-0 text-emerald-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                    <span x-show="!sidebarTerlipat" class="truncate">Laporan Neraca</span>
                </a>
                <a href="{{ route('laporan.laba_rugi') }}" class="flex items-center gap-2.5 px-2.5 py-1.5 rounded-lg text-slate-600 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-[#252837] hover:text-slate-900 dark:hover:text-slate-100 transition-colors">
