...
<div class="space-y-5">
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white dark:bg-[#14161F] p-4 sm:p-5 rounded-2xl border border-[#E2E8F0] dark:border-[#252837] shadow-sm">
        <div>
            ...
            <p class="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Pencatatan pengeluaran kas kantor, bahan bakar armada, dan operasional harian.</p>
        </div>
        <div class="flex items-center gap-2">
            <button class="inline-flex items-center gap-1.5 px-3 py-2 text-xs font-semibold text-white bg-rose-600 hover:bg-rose-700 rounded-xl transition-all shadow-sm">
            ...
            <table class="w-full text-xs">
                <thead class="bg-[#F8FAFC] dark:bg-[#1C1E2A] border-b border-[#E2E8F0] dark:border-[#252837] text-slate-500">
                    <tr>
                        ...
                        <th class="px-4 py-2.5 text-left font-semibold uppercase tracking-wider">Kategori Biaya</th>
                ...
                <tbody class="divide-y divide-[#EEF0F4] dark:divide-[#252837] text-slate-700 dark:text-slate-300">
                    <tr class="hover:bg-[#F8FAFC] dark:hover:bg-[#252837]/50 transition-colors">
                        <td class="px-4 py-3 font-mono font-medium text-rose-600 dark:text-rose-400">KAS-OUT-2026-081</td>
                        <td class="px-4 py-3 font-mono">01/09/2026</td>
                        <td class="px-4 py-3 font-medium">BBM & Tol Armada</td>
                        <td class="px-4 py-3 text-right font-mono tabular-nums font-bold text-rose-600 dark:text-rose-400">Rp 4.500.000</td>
                        <td class="px-4 py-3 text-slate-500 dark:text-slate-400">Uang jalan armada 3 unit rute Subang</td>
                        <td class="px-4 py-3 text-center space-x-2">
                            <button class="text-blue-600 dark:text-blue-400 hover:underline font-medium">Bukti Struk</button>
                        </td>
                    </tr>
                </tbody>
            </table>
